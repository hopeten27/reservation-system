          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Book appointments and manage your services efficiently with our professional booking system.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Simple, secure, and reliable booking management
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
              ...
              <p className="text-gray-600">
                Simple and intuitive booking process for quick appointment scheduling.
              </p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
              ...
              <p className="text-gray-600">
                Get help when you need it with our customer support team.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/register"
              className="px-8 py-3 bg-white text-blue-600 font-semibold rounded-lg hover:bg-gray-50 transition-colors duration-200"
            >
              Get Started
            </Link>
            <Link
